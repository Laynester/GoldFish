        ...
        <div class="col-lg-6">
            <div class="box grey">
                ...
                <p>
                    ...
                    {{ __('You must have an existing SWF Directory, otherwise your hotel will not function properly.') }}
                </p>
                <br>

                <small>
                    {{ __('It is recommended to use the avatar imager, provided by the nitro team, which can be found here: ') }}
                    <a href="https://git.krews.org/nitro/nitro-imager" target="_blank">
                        {{ __('Avatar imager') }}
                    </a>
                </small>
            </div>
            <div class="habblet d-none" id="habblet"></div>
        </div>
                ...
                <div class="box">
                    ...
                    <div class="form-group">
                        ...
                        <input class="inputs"
                               type="text"
                               placeholder="Alert"
                               value="{{ CMSHelper::settings('habbo_imager') }}"
                               name="imager"/>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="inputs"
                               type="text" placeholder="Motto"
                               value="{{ CMSHelper::settings('default_motto') }}"
                               name="motto"/>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="inputs"
                               type="text"
                               value="{{ CMSHelper::settings('group_badges') }}"
                               name="groupbadges"/>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="theme"
                                onkeypress="changePreview(this.value)"
                                onchange="changePreview(this.value)"
                        >
