<div class="legacy-box habbos">
  ...
  <div class="content habbogrid">
    ...
    <span onclick="window.location.href='{{ route('home', [$habbo->username]) }}'" class="ahabbo" onmouseover="openMouth('#habboid{{$habbo->id}}')" onmouseout="closeMouth('#habboid{{$habbo->id}}')">
